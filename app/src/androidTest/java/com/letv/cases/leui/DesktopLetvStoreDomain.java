...
public class DesktopLetvStoreDomain extends LetvTestCase {
    ...
    @Test
    @CaseName("进入应用商店打开")
    public void testLetvAppStoreOpen() throws UiObjectNotFoundException, RemoteException {
        addStep("打开LetvStore");
        gotoHomeScreen("应用");
        launchApp(AppName.LeStore, IntentConstants.LeStore);
            try{
    ...
    public void testLetvAppStoreDownload() throws UiObjectNotFoundException, RemoteException {
        addStep("打开LetvStore");
        gotoHomeScreen("应用");
        launchApp(AppName.LeStore, IntentConstants.LeStore);
        try{
